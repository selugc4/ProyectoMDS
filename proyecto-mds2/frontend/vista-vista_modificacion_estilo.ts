...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 100%; justify-content: center;" id="vaadinHorizontalLayout">
  <vaadin-vertical-layout theme="spacing" style="padding: var(--lumo-space-xl); align-items: center; border: 1px solid black; width: 30%;" id="vaadinVerticalLayout1">
   ...
   <vaadin-horizontal-layout theme="spacing-xl" style="width: 80%; align-items: center; margin-bottom: var(--lumo-space-xl); align-self: center; justify-content: space-between;" id="vaadinHorizontalLayout2">
   ...
   <vaadin-horizontal-layout theme="spacing" style="width: 60%;" id="vaadinHorizontalLayout3">
    <vaadin-button style="width: 100%;" id="vaadinButton">
      Modificar estilo 
    </vaadin-button>
   </vaadin-horizontal-layout>
   <vaadin-horizontal-layout theme="spacing" style="width: 60%;" id="vaadinHorizontalLayout4">
