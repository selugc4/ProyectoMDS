...
export class VistaVista_modificar_cancion extends LitElement {
  ...
  render() {
    return html`
<vaadin-vertical-layout theme="spacing" style="width: 100%; height: 100%; margin-bottom: var(--lumo-space-xl);">
   ...
   <vaadin-vertical-layout style="flex-grow: 0; width: 100%; height: 100%; justify-content: space-between;">
    ...
    <vaadin-horizontal-layout theme="spacing-xl" style="padding: var(--lumo-space-s); justify-content: space-between; width: 100%;">
     ...
     <vaadin-horizontal-layout theme="spacing" style="width: 50%; height: 100%;">
      <vaadin-text-area label="" placeholder="Compositores" style="width: 100%;"></vaadin-text-area>
     </vaadin-horizontal-layout>
    </vaadin-horizontal-layout>
    <vaadin-horizontal-layout theme="spacing-l" style="padding: var(--lumo-space-s); justify-content: space-between; width: 100%;">
     <vaadin-horizontal-layout theme="spacing" style="flex-direction: row; flex-grow: 1;">
      <label style="padding: var(--lumo-space-s); flex-grow: 0;">Productores (créditos)</label>
     </vaadin-horizontal-layout>
     <vaadin-horizontal-layout theme="spacing" style="width: 50%;">
      <vaadin-text-area label="" placeholder="Productores" style="width: 100%;"></vaadin-text-area>
     </vaadin-horizontal-layout>
    </vaadin-horizontal-layout>
    <vaadin-horizontal-layout theme="spacing-xl" style="padding: var(--lumo-space-s); justify-content: space-between; width: 100%;">
     <vaadin-horizontal-layout theme="spacing" style="flex-direction: row; flex-grow: 1;">
     ...
     <vaadin-horizontal-layout theme="spacing" style="width: 50%;">
      <vaadin-text-area label="" placeholder="Intérpretes" style="width: 100%;"></vaadin-text-area>
     </vaadin-horizontal-layout>
    </vaadin-horizontal-layout>
