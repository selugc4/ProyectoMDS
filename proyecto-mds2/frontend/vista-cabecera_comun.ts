...
<vaadin-vertical-layout style="width: 100%; height: 100%; flex-direction: row;">
 <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 20%;">
  <img style="flex-grow: 1; flex-shrink: 1; align-self: center; width: 200pt; height: 100%;" src="https://upload.wikimedia.org/wikipedia/commons/6/6b/Logo_UAL_Transparente.png">
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout>
  <vaadin-vertical-layout style="width: 100%; padding: var(--lumo-space-m);">
 ...
 <vaadin-horizontal-layout style="margin: var(--lumo-space-xl);">
