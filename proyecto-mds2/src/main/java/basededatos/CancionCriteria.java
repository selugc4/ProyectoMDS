...
public class CancionCriteria extends AbstractORMCriteria {
	...
	public CancionCriteria(Criteria criteria) {
		...
		contendor_cancion = new CollectionExpression("ORM_contendor_cancion", this);
	...
	public basededatos.Lista_ReproduccionCriteria createContendor_cancionCriteria() {
		return new basededatos.Lista_ReproduccionCriteria(createCriteria("ORM_contendor_cancion"));
	}
