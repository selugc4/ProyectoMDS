...
/**
 * A Designer generated component for the vista-eleccion_evento template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-eleccion_evento")
@JsModule("./vista-eleccion_evento.ts")
public class VistaEleccion_evento extends LitTemplate {
	...
	/**
     * Creates a new VistaEleccion_evento.
     */
    public VistaEleccion_evento() {
	...
	public DatePicker getVaadinDatePicker() {
		return vaadinDatePicker;
	}
	public void setVaadinDatePicker(DatePicker vaadinDatePicker) {
		this.vaadinDatePicker = vaadinDatePicker;
	}
