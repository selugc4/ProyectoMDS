...
/**
 * A Designer generated component for the vista-vista_dar_alta_album template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-vista_dar_alta_album")
@JsModule("./vista-vista_dar_alta_album.ts")
public class VistaVista_dar_alta_album extends LitTemplate {
     ...
     */
    public VistaVista_dar_alta_album() {
