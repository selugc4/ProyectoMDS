...
/**
 * A Designer generated component for the vista-vista_dar_alta_estilo template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-vista_dar_alta_estilo")
@JsModule("./vista-vista_dar_alta_estilo.ts")
public class VistaVista_dar_alta_estilo extends LitTemplate {
     ...
     */
    public VistaVista_dar_alta_estilo() {
