...
/**
 * A Designer generated component for the vista-vista_administracion template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-vista_administracion")
@JsModule("./vista-vista_administracion.ts")
public class VistaVista_administracion extends LitTemplate {
     ...
     */
    public VistaVista_administracion() {
