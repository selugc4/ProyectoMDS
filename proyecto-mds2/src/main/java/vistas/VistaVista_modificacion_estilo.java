...
/**
 * A Designer generated component for the vista-vista_modificacion_estilo template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-vista_modificacion_estilo")
@JsModule("./vista-vista_modificacion_estilo.ts")
public class VistaVista_modificacion_estilo extends LitTemplate {
	...
	/**
     * Creates a new VistaVista_modificacion_estilo.
     */
    public VistaVista_modificacion_estilo() {
